...
However, the data is not very complete, such as the lack of reference vaccines and the possibility of erroneous information. So the visualization can be misleading.We should be
careful in first identifying what we want to achive from our graphs before we work on them.
